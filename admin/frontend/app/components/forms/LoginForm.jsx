...
//       {/* ================= FOOTER ================= */}
//       <div className="bg-custom-blue w-11/12 md:max-w-md lg:max-w-lg h-[90px] lg:h-[135px] rounded-3xl">
...
const LoginForm = ({ handleClick }) => {
  ...
  return (
    <div className="w-full  min-h-screen flex flex-col justify-center items-center gap-1 mx-auto">
      {/* ================= CARD ================= */}
      <div className="bg-custom-blue w-11/12 md:max-w-md lg:max-w-lg h-[420px] lg:h-[500px] rounded-3xl">
        <div className="w-5/6 mx-auto pt-2">

          {/* ===== LOGO ===== */}
          <div className="flex items-center gap-1 pt-4">
            <div className="flex justify-center items-center">
              <Image src={BriefCasse} alt="logo" className="w-10 rounded" />
              
            </div>
      
              <p className="text-[1.7rem] font-anton text-normal text-white mt-[5px] uppercase tracking-wide">Briefcasse</p>
            
          </div>

          {/* ===== TEXT ===== */}
          <div className="mt-3">
            <p className="text-xl font-anton font-normal text-white tracking-wide">Welcome to BriefCasse</p>
