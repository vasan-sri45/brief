...
import { getMe, login, register, getEmployees, getUsers, sendForgotPasswordOtp, verifyForgotPasswordOtp, resetPasswordWithOtp, updateEmployee, updateProfileImage} from "../../controllers/auth/employee-controller.js";
...
router.patch("/employee/:id", employeeProtectRoute, adminAuth, wrapAsync(updateEmployee));
