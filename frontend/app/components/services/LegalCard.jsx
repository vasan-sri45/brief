            ...
            {items.map((item, idx) => (
              ...
              >
                <div className="flex-1 flex flex-col justify-between min-h-0">
                  <h3 className="font-lato font-bold text-base md:text-xl text-custom-blue text-center mb-4 md:mb-6 leading-tight transition-all duration-300 ease-out group-hover:text-black line-clamp-2">
                    {item.title}
                  </h3>
